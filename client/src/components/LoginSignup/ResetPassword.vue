                                  ...
                                  <div class="card-front">
                                      <div class="center-wrap">
                                          <div class="section text-center">
                                              ...
                                              <div class="form-group">
                                                  <input type="password" name="pass1" class="form-style" v-model="pass1"  id="respwd" autocomplete="off" placeholder="Enter your Password">
                                                  <i class="input-icon uil uil-at"></i>
                                              </div>
                                              <div class="form-group">
                                                  <input type="password" name="pass2" class="form-style" v-model="resetpass"  id="respwd1" autocomplete="off" placeholder="ReEnter your Password">
                                                  <i class="input-icon uil uil-at"></i>
                                              </div>	
                                              
                                              <button  class="btn mt-4" @click="pressedreset();" style="background-color:antiquewhite;">Submit</button>
